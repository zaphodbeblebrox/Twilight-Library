    ...
    <form onSubmit={CreateTimelineHandler}>
      ...
      <div>
        ...
        <div>
          ...
          <OptionListCC header={"NQ4"} options={CcData.node_quarry_4} />
        </div>
      </div>
      <div>
        <h3>Node Nemesis</h3>
        <div>
          <OptionListCC header="NN1" options={CcData.node_nemesis_1} />
          <OptionListCC header="NN2" options={CcData.node_nemesis_2} />
          <OptionListCC header="NN3" options={CcData.node_nemesis_3} />
        </div>
      </div>
      <div>
        <h3>Node Critical</h3>
        <div>
          ...
          <OptionListCC header="Special" options={CcData.node_special} />
        </div>
      </div>
      <div>
